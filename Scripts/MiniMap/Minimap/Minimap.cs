...
public class Minimap : MonoBehaviour
{
    ...
    private const float _defaultScaleStep = 0.25f;
    ...
    private void Awake()
    {
        ...
        RegisterPlayer(_player.GetComponent<IMinimapAgent>());
    }
    ...
    private void CreateAgentGraphics(IMinimapAgent agent)
    {
        ...
        agentGraphics.Initialize(agent.IconColor, agent.Name);
    }
    ...
    private Vector2 GetRemappedOffset()
        => -1 * _mapScale * MapUtils.GetRemappedRectPosition(_worldMapRect, _currentUiRect, _playerAgent.Pose.position.FromXZ());
